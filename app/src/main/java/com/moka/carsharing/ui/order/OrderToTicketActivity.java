...
import com.moka.carsharing.ui.tickets.CreateNewTicketActivity;
...
import com.moka.carsharing.adapter.OrderAdapter;
                    ...
                    try{
                        ...
                        if (jsonObject.getString("code").equals("200")){
                            ...
                            for (int i = 0; i < jsonArray.length(); ++i){
                                ...
                                mOrderModels.add(new OrderModel(obj.getString("id"),
