...
import com.moka.carsharing.widget.dialog.TicketConfirmDialog;
import com.moka.carsharing.widget.dialog.TicketTypeSelectDialog;
...
public class CreateNewTicketActivity extends AppCompatActivity {
    ...
    public void createOrder() {
        ...
        params.put("name", mTicketReceiverName.getText().toString());
        params.put("mobile", mTicketPhone.getText().toString());
        params.put("address", mTicketDetailAddress.getText().toString());
