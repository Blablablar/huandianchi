...
import com.moka.carsharing.adapter.ViewPagerAdapter;

import java.util.ArrayList;
import java.util.List;

/**
 * Created by blablabla on 2017/7/29.
 */
...
public class GuidePageActivity extends AppCompatActivity implements ViewPager.OnPageChangeListener {
    ...
    private void initViews() {
        ...
        guideThree.findViewById(R.id.button_guide).setOnClickListener(new View.OnClickListener() {
            @Override
